        ...
        while rib_index < (*ribs).len() {
            ...
            alt rib.kind {
                ...
                MethodRibKind(item_id, method_id) {
                  #debug("-------- item_id = %?, \
                         method_id = %?, def = %?", item_id, method_id, def);
    ...
    fn resolve_class(id: node_id,
        ...
        do self.with_type_parameter_rib(HasTypeParameters
            ...
            for class_members.each |class_member| {
                alt class_member.node {
                    class_method(method) {
                      self.resolve_method(MethodRibKind(id, method.id),
                                          method,
    ...
    fn resolve_implementation(id: node_id,
        ...
        do self.with_type_parameter_rib(HasTypeParameters
            ...
            for methods.each |method| {
                ...
                self.resolve_function(MethodRibKind(id, method.id),
                                      some(@method.decl),
                                      HasTypeParameters
